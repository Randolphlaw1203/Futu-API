...
public class OnPushUpdateOrder implements FTSPI_Trd, FTSPI_Conn {
    FTAPI_Conn_Trd trd = new FTAPI_Conn_Trd();

    public OnPushUpdateOrder() {
    ...
    @Override
    public void onPush_UpdateOrder(FTAPI_Conn client,
            TrdUpdateOrder.Response rsp) {
        if (rsp.getRetType() != 0) {
    ...
    public static void main(String[] args) {
        FTAPI.init();
        OnPushUpdateOrder trd = new OnPushUpdateOrder();
        trd.start();
